...
final class OpenAIConnectorTest: XCTestCase {
    ...
    func test_generatePrompt() {
        ...
        let mockPromptOptions = AIRequest(id: "123", platform: "Instagram", prompt: "Give me a caption about my dogs", tones: tones, includeEmojis: false, includeHashtags: false, captionLength: "veryShort", title: "", dateCreated: "", captions: [])
